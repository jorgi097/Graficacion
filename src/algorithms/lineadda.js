export const lineadda = (x1, y1, x2, y2) => { // Entrada de variables
    ...
    if (deltaX === 0) { // Evitar división por cero
        m = 'INFINITO';
    } else {
    ...
    for (let i = 0; i <= steps; i++) { // Calcular puntos de la linea
...
const result = lineadda(3,5,17,23); // Llamada a la función
